...
SELECT FIRST_NAME | | LAST_NAME AS NAME, DEPARTMENT_ID, MANAGER_ID FROM EMPLOYEES WHERE department_id LIKE '50';
...
SELECT FIRST_NAME | | LAST_NAME AS NAME, HIRE_DATE FROM EMPLOYEES WHERE HIRE_DATE LIKE'03%';
...
SELECT FIRST_NAME | | LAST_NAME AS NAME, SALARY FROM EMPLOYEES WHERE department_id LIKE '60' ORDER BY SALARY DESC;
