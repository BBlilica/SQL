...
-- SUBSTR(타겟, 시작위치, 자를개수) - 문자열 자르기, CONCAT - 문자열 붙이기
...
-- TRIM - 양쪽공백을 제거, LTRIM - 왼쪽에서 제거, RTRIM - 오른쪽에서 제거
